    ...
    <section id="despre" className="py-20 bg-roman-marble">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg p-8 shadow-lg">
          <CardHeader className=" text-roman-deep">
        ...
        <div className="bg-white rounded-xl p-8 shadow-lg mt-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-4">
              <h4 className="font-semibold text-roman-deep mb-2">
                {t("itinerary.transport.options")}
              </h4>
              {options.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-start gap-3 bg-roman-marble/60 rounded-lg p-4 shadow-sm hover:shadow-md transition-all"
                >
                  <span
                    className="text-base text-roman-deep/90 leading-snug"
